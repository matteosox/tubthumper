...
`tubthumper` requires Python 3.7 or greater. For Python 3.8 or greater, it has no external dependencies, i.e. standard library only, but earlier versions require [`typing-extensions`](https://pypi.org/project/typing-extensions/).
