...
docs:
    uv run sphinx-build -T -W -E --keep-going --color -b html docs/source docs/build/html
    uv run sphinx-build -T -W -E --keep-going --color -b doctest docs/source docs/build/doctest
